...
CREATE TABLE `el_pay_table` (
  ...
  `pay_money` varchar(255) NOT NULL COMMENT '需要的金额',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
-- ----------------------------
INSERT INTO `el_refresh_token` VALUES ('15', '1', '2021-05-10 10:08:00', '2021-05-10 10:08:00', '1', 'eyJhbGciOiJIUzI1NiJ9.eyJyb2xlIjpudWxsLCJwaG9uZSI6IjE0Nzk2MTgzNzk5IiwiaWQiOjEsImV4cCI6MTYyMDY5ODg3OX0.ufDG88DjqiCj93WMbgYv90nXMJz2fRh5_46AU0Ilghs', '$2a$10$z2o0Ax7VvnRzQwOkYvsfauRqDIz/tJVOWCxO7i4kcJG3A7CtBbgbm');
...
-- Records of el_user
-- ----------------------------
INSERT INTO `el_user` VALUES ('1', '1', '2021-04-29 19:38:25', '2021-04-29 19:38:25', '0', '14796183799', '202cb962ac59075b964b07152d234b70', null, '4');
INSERT INTO `el_user` VALUES ('2', '1', '2021-05-08 20:01:51', '2021-05-08 20:01:51', '0', '14796183798', '$2a$10$J7mYdH7hu5HoR4p3Jh4qS.L9NoyB2biItGgJnoIBVlx4u4ymI0RFe', null, '4');
INSERT INTO `el_user` VALUES ('3', '1', '2021-05-08 21:14:02', '2021-05-08 21:14:02', '0', '14796183791', '$2a$10$E0DOcsSMrsgx5klsopXZlOj8qyHuIeOs7/r6s8CgQyafXcI00bXYS', null, '4');
INSERT INTO `el_user` VALUES ('4', '1', '2021-05-08 21:15:07', '2021-05-08 21:15:07', '0', '14796183790', '$2a$10$aqG2YtUB9ibY0pIYYDvCjOfiJtlwGHkH2rZgn1KSPOnjs2qAR188G', null, '4');
INSERT INTO `el_user` VALUES ('5', '1', '2021-05-08 21:16:02', '2021-05-08 21:16:02', '0', '18878149218', '$2a$10$sLhEnllc9w4Xng7dnc.RV.TpMP1yhpCRHDXGmWf/M3hm/mFgjTPGS', null, '4');
